<div class="row">
    ...
    <div class="col-lg-6">
        <h3 class="text-danger">Input Kerusakan</h3><hr>
            <form method="POST" action="<?php echo base_url('admin/rusak/ubah');?>" id="form_rusak">
                <div class="form-group">
                    <select class="form-control" name="kode_periode" onchange="this.form.submit()">
                        <option value="" >Pilih Periode</option>
                        <?php foreach($periode as $key => $row): ?>
                        <?php if($this->uri->segment(5)==$row['kode_periode']){
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kode_kerusakan" class="form-control" value="<?php echo $data['kode_kerusakan']?>">
                </div>
                <div class="form-group">
                    <label>Nama Kerusakan</label>
                    <input type="text" name="nama_kerusakan" class="form-control" value="<?php echo $data['nama_kerusakan']?>">
                </div>
                <div class="form-group">
                    <label>Ruang</label>
                    <input type="text" name="ruang" class="form-control" value="<?php echo $data['ruangan']?>">
                </div>
                <div class="form-group">
