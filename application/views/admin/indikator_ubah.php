<div class="row">
    ...
    <div class="col-lg-6">
        <h3 class="text-danger">Ubah Indikator</h3><hr>
                <form method="POST" action="<?php echo base_url('admin/indikator/ubah');?>" id="form_indikator">
                    <div class="form-group">
                        <select class="form-control" name="kode_kriteria">
                            <option value="" >Pilih Kriteria</option>
                            <?php foreach($kriteria as $key => $row): ?>
                            <?php if($this->uri->segment(5)==$row['kode_kriteria']){
                    ...
                    <input type="hidden" name="kode_indikator" value="<?php echo $data['kode_indikator']?>">
                    <div class="form-group">
                        <label>Indikator</label>
                        <input type="text" name="nama_indikator" value="<?php echo $data['nama_indikator']?>" class="form-control" >
                    </div>
                    <div class="form-group">
                        <label>Nilai</label>
